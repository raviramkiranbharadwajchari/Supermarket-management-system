...
Public Class RemoveGlossary
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Con.Open()
        Dim query1 = " select * from [Glossary1]  where Product ='" & TextBox1.Text & "' "
    ...
    Private Sub RemoveGlossary_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        Dim query1 = "Delete from Glossary1  where Product ='" & TextBox1.Text & "'"
