...
Public Class CheckElectronics
    ...
    Private Sub LinkLabel1_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles LinkLabel1.LinkClicked
        ...
        Else
            ...
            Dim query = "select * from Table3 where [PhoneNumber] = '" & TextBox3.Text & "' and [Date] = '" & DateTimePicker1.Text & "'"
            Dim cmd = New SqlCommand(query, Con)
            Dim da = New SqlDataAdapter(cmd)
            Dim ds = New DataSet()
            Dim Table2 As New DataTable
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        ElseIf (ComboBox1.Text.Equals("Cash")) Then
            ...
            If ComboBox2.Text = "Electronics" Then
                Dim a As New PrintElectronics
                a.StringPass = TextBox2.Text
                a.Show()
                Me.Close()
