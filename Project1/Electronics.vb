...
Public Class Electronics
    ...
    Private Sub Electronics_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Con.Open()
        Dim query = "select * from Electronics"
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        Dim Con = New SqlConnection("Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\Project1\Project1\Project11.vb.mdf;Integrated Security=True;Connect Timeout=30")
        Con.Open()
        Dim query1 = " select * from Electronics where Product ='" & TextBox2.Text & "' "
        Dim cmd = New SqlCommand(query1, Con)
        Dim da = New SqlDataAdapter(cmd)
        Dim ds = New DataSet()
        Dim Table2 As New DataTable
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        If (TextBox2.Text <> "" And TextBox3.Text <> "") Then
            ...
            Dim query1 = "insert into [Table3] values ('" & TextBox2.Text & "','" & Price.Text & "','" & TextBox3.Text & "','" & DateTimePicker2.Text & "','" & TextBox1.Text & "')"

            Dim query2 = "Update Electronics set AvailableQuantity='" & Label6.Text & "' where Product='" & TextBox2.Text & "'"
